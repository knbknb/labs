...
p=10^-7 ##1 in 10,000,000 chances of winning
N=5*10^6 ##5,000,000 tickets sold
...
library(maPooling) ##available from course github repo. only 1 .Rdata file
