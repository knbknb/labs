...
result <- replicate(B,{
  ...
  c(fp.bonf=FP1,fn.bonf=FN1,fp.bh=FP2,fn.bh=FN2,fp.storey=FP3, fn.storey=FN3)
  })
  
#Then the false pos rates are
cat("False positive rates:")
(ans <- rowMeans(result[c(1,3,5),])/(m-positives))
#and the false neg rates are
cat("False negative rates:")
(ans <- rowMeans(result[c(2,4,6),])/(positives))
```
